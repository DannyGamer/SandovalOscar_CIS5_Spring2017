 ...
 * Created on May 31st, 2017, 12:30 PM
 * Purpose: Game of Blackjack Version 4
 */
...
int sum(int*);
void rules();
//void inArrays(const string*, short*, short*, int*, int*);
bool playAgain(int, int, bool);
...
int main(int argc, char** argv) {
    ...
    //inArrays(cards, cardVal, cardTot, pHand, dHand);
...
//void inArrays(const string* cards, short* cardVal, short* cardTot, int* pHand, int* dHand)
//{
//    cards = { "Ace", "Two", "Three", "Four", "Five", "Six", "Seven", 
//                               "Eight", "Nine", "Ten", "Jack", "Queen", "King" };
//    cardVal = { 11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10 };
//    cardTot = { 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4 };
//}

bool playAgain(int win, int loss, bool askAgn)
{
...
void outputFile(int win, int loss)
{
    //Declare and initialize output file
    ofstream out;
    char outName[] = "GameStats.dat";
